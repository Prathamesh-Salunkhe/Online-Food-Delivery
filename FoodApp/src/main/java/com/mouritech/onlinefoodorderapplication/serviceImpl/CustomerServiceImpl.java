...
public void addCustomerInformation(Customer customer) {
	...
	public ResponseEntity<?> updatecustomerinfobyname(Customer customer) {
		...
		@Override
		public ResponseEntity<?> checkCustomerEmailAndPassword(Customer customer) {
		
		 Customer checkEmailExisting = customerRepository.findByCustomerEmail(customer.getCustomerEmail());
		 Customer checkpasswordExisting = customerRepository.findByCustomerPassword(customer.getCustomerPassword());
	...
	/*
	 * @Override public ResponseEntity<?> insertCarts(CustomerCartsDto
	 * customerCartsDto) {
	 * 
	 * Customer checkEmailExisting =
	 * customerRepository.findByCustomerEmail(customerCartsDto.getCustomerEmail());
	 * checkEmailExisting.setCarts(null);
	 * 
	 * 
	 * Customer checkpasswordExisting =
	 * customerRepository.findByCustomerPassword(customerCartsDto.
	 * getCustomerPassword());
	 ...
	 * 
	 * return
	 * ResponseEntity.status(HttpStatus.NOT_FOUND).body("password doesnt match"); }
	 * 
	 * else {
	 * 
	 ...
	 * 
	 * 
	 * cartsRepository.saveAll(checkEmailExisting.getCarts()); return
	 * ResponseEntity.ok().body("carts inserted"); }
	 * 
	 * }
	 */
	...
	@Override
	public void deleteCustomerById(String customerId) throws CustomerNotFound {
		// TODO Auto-generated method stub
		
	}

	/*
	 * @Override public void deleteCustomerById(String customerId) throws
	 * CustomerNotFound { // TODO Auto-generated method stub Customer
	 * existingCustomer =
	 * CustomerRepository.findByCustomerId(customerId).orElseThrow(() -> new
	 * CustomerNotFoundException("Customer not found with id " + customerId));
